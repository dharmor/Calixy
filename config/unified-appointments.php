...
return [
    'database_library_path' => env('UNIFIED_APPOINTMENTS_DATABASE_LIBRARY_PATH', 'C:\\Apache24\\htdocs\\Unified Databases'),
    ...
    'app_timezone' => env('UNIFIED_APPOINTMENTS_TIMEZONE', config('app.timezone', 'UTC')),
    'routes' => [
        'enabled' => env('UNIFIED_APPOINTMENTS_ROUTES_ENABLED', true),
